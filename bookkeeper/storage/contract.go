...
type (
	...
	TotalCoins struct {
		...
		BalanceTotalMainnetRewardPoolContribution float64    `redis:"mainnet_reward_pool_contribution"`
	...
	Columns        struct {
		...
		soloLastMainnetRewardPoolContributionProcessedAt       *proto.ColDateTime64
		forT0LastMainnetRewardPoolContributionProcessedAt      *proto.ColDateTime64
		forTMinus1LastMainnetRewardPoolContributionProcessedAt *proto.ColDateTime64
		...
		balanceSoloMainnetRewardPoolContribution               *proto.ColFloat64
		balanceT0MainnetRewardPoolContribution                 *proto.ColFloat64
		balanceT1MainnetRewardPoolContribution                 *proto.ColFloat64
		balanceT2MainnetRewardPoolContribution                 *proto.ColFloat64
		balanceForT0MainnetRewardPoolContribution              *proto.ColFloat64
		balanceForTMinus1MainnetRewardPoolContribution         *proto.ColFloat64
