...
WITH valid_users AS (
                    SELECT DISTINCT ON (id, created_at)
                            created_at, id, id_t0, id_tminus1, pre_staking_allocation, pre_staking_bonus, balance_solo, balance_solo_ethereum, balance_t0, balance_t0_ethereum, balance_for_t0, balance_t1_ethereum, balance_for_tminus1, balance_t2_ethereum, balance_solo_mainnet_reward_pool_contribution, balance_t0_mainnet_reward_pool_contribution, balance_t1_mainnet_reward_pool_contribution, balance_t2_mainnet_reward_pool_contribution
                    FROM %[1]v
...
SELECT  u.created_at                                                                                                                                                                                    AS created_at,
        ...
        SUM(u.balance_solo_mainnet_reward_pool_contribution+u.balance_t0_mainnet_reward_pool_contribution+u.balance_t1_mainnet_reward_pool_contribution+u.balance_t2_mainnet_reward_pool_contribution)  AS balance_total_mainnet_reward_pool_contribution
FROM valid_users u
